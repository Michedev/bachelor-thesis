...
\subsubsection{Modelli ad eventi}  
   I modelli ad eventi\citet{mccallum1998comparison} sono distribuzioni di probabilita' che considerano gli attributi come probabilita' di eventi. Ci sono 3 modelli usati con $\textit{Naive Bayes}$ che sono:
\begin{itemize}
