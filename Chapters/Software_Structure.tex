...
Dopo non abbiamo una fase di addestramento del modello perche' nel codice su dispositivo \text{Android} e' stato usato il \textit{knn} e quindi c'e' direttamente la fase di ricerca della posizione, od in termini piu' tecnici per quanto riguarda l'apprendimento automatico, la predizione dell'etichetta.
\\\\
